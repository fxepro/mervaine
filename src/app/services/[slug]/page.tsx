...
const SERVICES_DATA: Record<string, any> = {
  "rights-administration": {
    ...
    `,
    pillars: [
      { title: "Portfolio Management", description: "Active oversight of global rights portfolios including registration, maintenance, and defense.", icon: ShieldCheck },
      { title: "Royalty Collection", description: "Rigorous collection and distribution systems across international jurisdictions.", icon: Globe },
      { title: "Estate Coordination", description: "Harmonizing rights management for multi-generational estates and institutional heirs.", icon: History }
    ],
    capabilities: [
      "Global Licensing Administration", "Chain-of-Title Verification", "Contractual Compliance Monitoring", "Digital Rights Management (DRM) Strategy", "Royalty Auditing and Forensic Accounting", "Heir and Beneficiary Coordination", "IP Portfolio Valuation"
    ]
  },
  "royalty-recovery": {
    ...
    longDescription: `
      In the modern digital economy, the flow of royalties is often obscured by systemic fragmentation and metadata degradation. Mervaine's Royalty Recovery division operates as a forensic financial entity, dedicated to identifying and reclaiming capital lost to 'black box' funds.
    `,
    pillars: [
      { title: "Forensic Auditing", description: "Deep-dive analysis into historical royalty flows to identify structural misallocations.", icon: SearchCheck },
      { title: "Global Reclamation", description: "Navigating international collection societies and digital DSPs to secure unclaimed funds.", icon: Globe },
      { title: "Arrears Settlement", description: "Aggressive pursuit and negotiation of past-due payments.", icon: TrendingUp }
    ],
    capabilities: [
      "Historical Performance Audits", "Black Box Fund Identification", "Suspense Account Resolution", "Global DSP Metadata Scrubbing", "International Society Conflict Management", "Mechanical & Performance Royalty Tracking", "Forensic Accounting Dossiers"
    ]
  },
  "copyright-research": {
    ...
    `,
    pillars: [
      { title: "Chain-of-Title Analysis", description: "Verifying every transfer of ownership from the moment of creation to the present day.", icon: Landmark },
      { title: "Legal Clearance", description: "Determining the exact legal status and expiration dates of copyright protection globally.", icon: Scale },
      { title: "Archival Forensics", description: "Retrieving lost documentation and physical evidence to support ownership claims.", icon: History }
    ],
    capabilities: [
      "Global Copyright Registry Searches", "Assignment and Transfer Verification", "Termination Rights Analysis", "Work-for-Hire Status Review", "International Reciprocity Assessment", "Litigation Support Documentation", "Ownership Conflict Resolution"
    ]
  },
  "estate-representation": {
    ...
    longDescription: `
      Estate Representation at Mervaine Holdings is an exercise in sophisticated advocacy and long-term stewardship.
    `,
    pillars: [
      { title: "Legacy Stewardship", description: "Long-term strategic planning to ensure the influence of the creator endures.", icon: Landmark },
      { title: "Heir Coordination", description: "Facilitating transparent communication between multiple beneficiaries.", icon: UserCheck },
      { title: "Succession Frameworks", description: "Implementing structural legal and fiduciary solutions for asset control transition.", icon: ShieldCheck }
    ],
    capabilities: [
      "Beneficiary Governance & Voting Models", "Family Office Integration & Reporting", "Institutional Trustee Advisory", "Philanthropic Bequest Management", "Dispute Mediation & Conflict Resolution", "Posthumous Brand Identity Strategy", "Estate Asset Inventory & Valuation", "Inter-generational Transfer Planning"
    ]
  },
  "archive-digitization": {
    ...
    icon: History,
    imageId: "archive-digitization",
    description: "Conversion of physical and analog collections into structured, museum-grade digital systems.",
    longDescription: `
      Archive Digitization at Mervaine Holdings is where physical history meets digital permanence. We bridge the gap between decaying physical archives and digital accessibility.
    `,
    pillars: [
      { title: "Forensic Imaging", description: "Ultra-high-resolution capture of fragile historical artifacts.", icon: Scan },
      { title: "Metadata Structuring", description: "Organizing archives into searchable databases with AI-assisted tagging.", icon: History },
      { title: "Legacy Continuity", description: "Implementing long-term storage and accessibility strategies.", icon: ShieldCheck }
    ],
    capabilities: [
      "Glass Plate Negative Recovery", "Manuscript & Rare Book Digitization", "Multi-Spectral Imaging", "Large-Format Scanning", "AI-Powered OCR", "Metadata Enrichment & Cataloging", "Secure Archival Cloud Storage"
    ]
  },
  "licensing-monetization": {
    ...
    category: "Growth",
    icon: TrendingUp,
    imageId: "licensing-monetization",
    ...
    capabilities: [
      "Synchronization Licensing for Media", "Brand Heritage Marketing Strategies", "Derivative Work & Adaptation Strategy", "Royalty Stream Optimization", "AI Dataset Curation & Licensing", "Global Publishing Rights Management"
    ]
  },
  "rights-intelligence-reports": {
    ...
    capabilities: [
      "Due Diligence & M&A Support Dossiers", "Catalog Performance Benchmarking", "Global Rights Mapping & Visualization", "Trend Analysis & Forecast Intelligence", "Chain-of-Title Health Audits"
    ]
  }
};
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="journal-grid items-start">
            ...
            <div className="col-span-12 lg:col-span-4 lg:col-start-9 mt-12 lg:mt-0">
              <div className="relative aspect-[4/3] mb-8 overflow-hidden border border-foreground/10 grayscale group-hover:grayscale-0 transition-all duration-700">
                {imageData && (
                  <Image 
